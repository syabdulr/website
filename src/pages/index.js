...
import { LinkArrow, GithubIcon, TwitterIcon } from "@/components/Icons";
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-12">
              <FeaturedProject
                ...
                twitter="https://cabbbagee.itch.io/miniature-nightmares"
              />
            </div>
...
const FeaturedProject = ({ type, title, summary, summary2, summary3, img, link, github, twitter }) => {
  return (
    <article className="w-full flex items-center justify-between relative rounded-br-2xl rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12 dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4">
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6">
        ...
        <div className="mt-2 flex items-center">
          ...
          <Link href={twitter} target="_blank" className="w-10"> <TwitterIcon /> </Link>
